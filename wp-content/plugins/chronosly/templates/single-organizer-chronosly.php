...
<?php   if($Post_Type_Chronosly->settings["chronosly-organazires-list-url"]){ ?>
                <a href="<?php  echo $Post_Type_Chronosly->settings["chronosly-organazires-list-url"];?>" class="back"><i class="fa fa-chevron-left"></i> <?php _e("Organizers list","chronosly") ?></a>

<?php } else {?>
                <a href="<?php  echo (get_option('permalink_structure')?get_post_type_archive_link( 'chronosly_organizer' ):get_site_url()."/index.php?post_type=chronosly_organizer") ;?>" class="back"><i class="fa fa-chevron-left"></i> <?php _e("Organizers list","chronosly") ?></a>
<?php }
...
echo "<div class='chronosly-content-block' style='".$stilo.";clear:both;'>";
                ...
                if (have_posts() ) {
                    ...
                    ob_start();
                    $Post_Type_Chronosly->template->print_template($xid, "dad8", "", "", "front");
