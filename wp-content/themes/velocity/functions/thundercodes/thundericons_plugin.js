...
function writeIcons(){
		...
		W = W - 80;
		H = H - 184;
		tb_show( 'velocityIcons', '#TB_inline?width=' + W + '&height=' + H + '&inlineId=thundercodes-form' );
...
function sendIcon(daclass){
	tinyMCE.activeEditor.execCommand('mceInsertContent', 0, "[velocityicon icon='"+daclass+"' size='15px' class='']");
	// closes Thickbox
	tb_remove();
}