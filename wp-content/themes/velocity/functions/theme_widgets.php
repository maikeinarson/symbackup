...
class velocityLatestProjects extends WP_Widget {
	...
	public function __construct(){
			 parent::__construct(
		        'velocityLatestProjects',
		        __( 'Velocity Latest Projects', 'velocity' ),
		        array(
		            'classname'   => 'velocityLatestProjects',
		            'description' => __( 'A widget to display links to the latest projects', 'velocity' )
		        )
		      );
	}
...
class velocityTwitterTimelinefeed extends WP_Widget {
 ...
 public function __construct(){
	 parent::__construct(
        'velocityTwitterTimelinefeed',
        __( 'Velocity Twitter Timeline Feed', 'velocity' ),
        array(
            'classname'   => 'velocityTwitterTimelinefeed',
            'description' => __( 'Twitter Timeline Widget', 'velocity' )
        )
      );
}
...
class velocityPosts extends WP_Widget {
	...
	public function __construct(){
		 parent::__construct(
	        'velocityPosts',
	        __( 'Velocity Popular/Latest Posts', 'velocity' ),
	        array(
	            'classname'   => 'velocityPosts',
	            'description' => __( 'A popular/latest posts widget.', 'velocity' )
	        )
	      );
	}
...
class velocityArchives extends WP_Widget
{
  ...
  public function __construct(){
		 parent::__construct(
	        'velocityArchives',
	        __( 'Velocity Archives', 'velocity' ),
	        array(
	            'classname'   => 'velocityArchives',
	            'description' => __( 'Displays the Blog Archives', 'velocity' )
	        )
	      );
	}
...
class velocityCategories extends WP_Widget
{
  ...
  public function __construct(){
		 parent::__construct(
	        'velocityCategories',
	        __( 'Velocity Categories', 'velocity' ),
	        array(
	            'classname'   => 'velocityCategories',
	            'description' => __( 'Displays a list of Blog Categories', 'velocity' )
	        )
	      );
	}
...
-----------------------------------------------------------------------------------*/	
	...
	class velocitySocials extends WP_Widget {
	  ...
	  public function __construct(){
			 parent::__construct(
		        'velocitySocials',
		        __( 'Velocity Socials Widget', 'velocity' ),
		        array(
		            'classname'   => 'velocitySocials',
		            'description' => __( 'Simple list of Social Profile icons', 'velocity' )
		        )
		      );
		}
