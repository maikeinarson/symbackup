...
<section class="row">
    ...
    <?php if(have_posts()) :
		while(have_posts()) : the_post();
			...
			if(strpos($the_content, '[vc_row][vc_column width="1/1"][background_block')===0 || strpos($the_content, '[vc_row el_position="first"][vc_column width="1/1"][background_block')===0){	
