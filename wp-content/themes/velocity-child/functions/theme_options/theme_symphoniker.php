...
/*
Velocity Child Theme - theme_symphoniker.php
*/
...
//Symphoniker
	...
	update_option('velocity_theme_header_options',array(
			...
			"velocity_pagetitleline_color" => "#156025",
	...
	update_option('velocity_theme_color_options',array(
			"velocity_color_highlight" => "#22b241"
	));
	
	update_option('velocity_theme_background_options',array(
			"velocity_img_bgdefault" => $template_url_first."/img/tiles/bg_green2.jpg", 
			"velocity_img_bgtype" => "full"
	));
